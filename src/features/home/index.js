...
export { default as ContactsPage } from './page/ContactsPage';
export { default as JournalPage } from './page/JournalPage';
export { default as ContactDetailPage } from './page/ContactDetailPage';
